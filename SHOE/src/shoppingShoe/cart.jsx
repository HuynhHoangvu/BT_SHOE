export default function Cart(props) {
    const {listCart, handleRemoveShoeProps,hanleQuantityProps} = props;
  ...
  <div className="flex items-center space-x-2">
    <button  onClick={()=>hanleQuantityProps(item.id,false)}
      type="button"
    ...
    <button
      type="button" onClick={()=>hanleQuantityProps(item.id,true)}
    ...
    >
      +
          ...
          <td className="px-6 py-4">
<button
           onClick={()=> handleRemoveShoeProps(item.id)}
            type="button"
